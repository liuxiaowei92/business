package com.study.business.utils;
...
public class Util {
    ...
    //为ViewPager结构化数据
    public static ArrayList<HomeBodyValue> handleData(HomeBodyValue value) {
        ArrayList<HomeBodyValue> values = new ArrayList<>();
        ...
        for (int i = 0; i < titles.length; i++) {
            HomeBodyValue tempValue = new HomeBodyValue();
