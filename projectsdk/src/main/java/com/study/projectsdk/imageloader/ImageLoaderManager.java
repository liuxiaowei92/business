package com.study.projectsdk.imageloader;
...
import com.study.projectsdk.R;

/**
 * created by lxw on 2019/8/21
 *
 * @function 初始化 UniverImageSalImageLoader,并用来加载图片
 */
public class ImageLoaderManager {

    private static final int THREAD_COUNT = 4;//表明我们的url最多可以有多少线程
    private static final int PROPRITY = 2;//表明我们图片加载一个优先级
    ...
    private DisplayImageOptions getDefultOptions() {
        DisplayImageOptions options=new DisplayImageOptions.Builder()
                .showImageForEmptyUri(R.mipmap.xadsdk_img_error) //图片地址为空的时候加载默认图片
                .showImageOnFail(R.mipmap.xadsdk_img_error)
