...
import com.study.business.adapter.PhotoPagerAdapter;
import com.study.business.module.home.HomeFooterValue;
import com.study.business.module.home.HomeHeadValue;
import com.study.business.view.viewpagerindictor.CirclePageIndicator;
...
public class HomeHeaderLayout extends RelativeLayout {
     ...
     * Data
     */
    private HomeHeadValue mHeaderValue;
    private ImageLoaderManager mImageLoader;



    public HomeHeaderLayout(Context context,HomeHeadValue headerValue) {
        this(context,null,headerValue);
    }

    public HomeHeaderLayout(Context context, AttributeSet attrs,HomeHeadValue headerValue) {
        super(context,attrs);
        mContext=context;
    ...
    private void initView() {
        ...
        for (HomeFooterValue value : mHeaderValue.footer) {
            mFootLayout.addView(createItem(value));
        }
        mHotView.setText(mContext.getString(R.string.today_zuixing));
    }

    private HomeBottomItem createItem(HomeFooterValue value) {
